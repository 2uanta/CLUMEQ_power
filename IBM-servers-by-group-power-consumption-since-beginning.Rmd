...
library(ggplot2)
# load the dataset
data <- read.csv("C:/Users/Quan Nguyen/OneDrive/Workbench/R/Projects/CLUMEQ power/total-by-category", 
...
```{r}
# load the dataset
data <- read.csv("C:/Users/Quan Nguyen/OneDrive/Workbench/R/Projects/CLUMEQ power/total-by-row", 
                 strip.white=TRUE,na.strings=c("", "NA"),header=FALSE)
names(data)[1]="datetime"
names(data)[2]="row"
names(data)[3]="watt"
...
```{r}
# load the dataset
data <- read.csv("C:/Users/Quan Nguyen/OneDrive/Workbench/R/Projects/CLUMEQ power/total-by-rack", 
                 strip.white=TRUE,na.strings=c("", "NA"),header=FALSE)
names(data)[1]="datetime"
names(data)[2]="rack"
names(data)[3]="watt"
