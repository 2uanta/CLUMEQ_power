...
library(TTR)
library(ggplot2)
data = read.xlsx(file="ETS-data/2014/CLUMEQ - 2014-07.xlsx", sheetName = "data", startRow = 2, colIndex = c(11,12))

#data = read.xlsx(file="ETS-data/2015/CLUMEQ - 2015-03.xlsx", sheetName = "data", startRow = 2, colIndex = c(11,12))
