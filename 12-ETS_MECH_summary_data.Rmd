...
data = read.xlsx(file="ETS-data/2015/CLUMEQ_MEC - 2015-07.xlsx", sheetName = "data", startRow = 2, colIndex = c(11,12))
```
...
plot(decompose(ts(coredata(data.z), frequency=288, start=c(23,12))),xlab="Day")
